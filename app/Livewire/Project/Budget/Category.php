...
class Category extends Component
{
    ...
    public function refresh() {
        ...
        $this->categories = ModelsCategory::getAllCategory();
    }
    ...
    public function render()
    {
        ...
        return view('livewire.project.budget.category', ['categories' => $this->categories]);
    }
    ...
    public function store()
    {
        ...
        try {
            if ($this->categoryId) {
                ModelsCategory::update(['name' => $this->name], $this->categoryId);
    ...
    public function edit($id)
    {
        ...
        $category = ModelsCategory::getCategoryById($id);
