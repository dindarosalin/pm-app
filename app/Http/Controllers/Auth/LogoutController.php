...
class LogoutController extends Controller
{
    ...
    public function logout(Request $request)
    {
        ...
        //     if($request->session()->has('old_take_over_user_id') && $request->session()->has('old_take_over_user_email')){
        ...
        //         $old_take_over_user_email      = Crypt::decryptString($request->session()->pull('old_take_over_user_email'));
        ...
        //             $params = [
        //                 'id'            => LogoutModel::makeMicrotimeID(),
        //                 'email'           => $old_take_over_user_email,
