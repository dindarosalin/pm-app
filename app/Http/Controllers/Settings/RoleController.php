...
class RoleController extends BaseController
{
    ...
    public function addProcess(Request $request)
    {
        ...
        if (Role::insert($params)) {
            ...
            return redirect('/settings/role/add');
        }
    }
    ...
    public function editProcess(Request $request)
    {
        ...
        if (Role::update($request->role_id, $params)) {
            ...
            // flash message
            session()->flash('danger', 'Data gagal disimpan.');
            return redirect('/settings/role/edit/'.$request->role_id);
        }
    }
    ...
    public function access_right($id)
    {
        // Role::authorize($this->menu_id, 'UAR');
        return view('settings.role.access_right', ['role_id' => $id, 'menu_id' => $this->menu_id]);
    }
}
