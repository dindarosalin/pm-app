...
<html>
  <head>
    <meta charset="utf-8" />
    <title>Lupa Password - Ports Web Base</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0">
    <meta name="author" content="Abarobotics">
    <meta name="description" content="Ports Web Base">
    <meta name="application-name" content="Ports Web Base">
    <meta name="generator" content="Ports Abarobotics">
    <meta name="robots" content="noindex, nofollow">
    <meta property="og:type" content="website">
    <meta property="og:title" content="@yield('title')">
    <meta property="og:description" content="Ports Web Base">
    <meta property="og:url" content="{{url()->current()}}">
    <meta property="og:site_name" content="Ports Web Base">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="app-brand justify-content-center">
                        <a href="{{url('/')}}" class="app-brand-link gap-2"  style="max-width: 50%;">
                    ...
                    <form id="formAuthentication" class="mb-3" action="{{ url('/lupa-password/process') }}" method="POST">
                        {{ csrf_field()}}
                    ...
                    <p class="text-center text-muted">
                        <a href="{{url('/login')}}"><i class="bx bx-arrow-back"></i> Kembali ke halaman masuk</a>
                    </p>
                </div>
            </div>
        </div>
