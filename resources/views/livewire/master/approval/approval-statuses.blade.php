        ...
        <div class="offcanvas-body">
            <form wire:submit='save'>
                ...
                <div class="mb-3">
                    ...
                    <input wire:model='code' class="form-control form-control-sm" type="text"
                        placeholder="Approval Name">
                </div>
                <div class="mb-3 form-floating">
                    <textarea class="form-control" wire:model='description' placeholder="Description"
                        id="floatingTextarea2" style="height: 100px"></textarea>
                    <label for="floatingTextarea2">Desctiption</label>
                </div>
