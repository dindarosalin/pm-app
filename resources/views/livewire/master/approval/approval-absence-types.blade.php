...
<div>
    <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offCanvasForm"
        ...
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offCanvasFormLabel">Form absence Types:</h5>
            <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            <form wire:submit='save'>
                <div class="mb-3">
                    <label class="form-label">absence Name:</label>
                    <input wire:model='name' class="form-control form-control-sm" type="text"
                        placeholder="absence Name">
                </div>
                <div class="mb-3 form-floating">
                    <textarea class="form-control" wire:model='description' placeholder="absence Description"
                        id="floatingTextarea2" style="height: 100px"></textarea>
                    <label for="floatingTextarea2">absence Desctiption</label>
                </div>
