...
<div>
    <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offCanvasForm"
        ...
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offCanvasFormLabel">Form UOM</h5>
        ...
        <div class="offcanvas-body">
            <form wire:submit='save'>
                ...
                <div class="mb-3">
                    ...
                    <textarea wire:model='description' class="form-control form-control-sm" placeholder="Description"></textarea>
                </div>
