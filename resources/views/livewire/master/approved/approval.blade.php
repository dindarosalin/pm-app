{{-- <div>
        ...
        <button wire:click='btnApproval_Clicked' class="btn btn-sm btn-outline-success mb-3 mx-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#createApproval" aria-controls="createApproval">
            Buat Jenis Approval
        </button>
    </div>

    <div class="offcanvas offcanvas-end" tabindex="-1" id="approvalForm" aria-labelledby="createApprovalLabel">
