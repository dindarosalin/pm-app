<div>
    ...
    <div class="d-flex justify-content-end">
        <button class="btn btn-sm btn-success mb-3 mx-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#createPlan" aria-controls="createPlan">
            Create Expense
        </button>
        <button class="btn btn-sm btn-outline-success mb-3 mx-2" type="button" data-bs-toggle="offcanvas">
            View Category
        </button>
        <button class="btn btn-sm btn-outline-success mb-3 mx-2" type="button" data-bs-toggle="offcanvas">
            View Sub Category
        </button>
        <button class="btn btn-sm btn-primary mb-3 mx-2">
        ...
        <table id="project-table" class="table table-striped table-hover table-sm" style="width:100%">
            <thead class="text-success fw-medium">
                <tr>
                    ...
                    <th class="fw-medium text-center">Nama</th>
                    <th class="fw-medium text-center">UOM</th>
