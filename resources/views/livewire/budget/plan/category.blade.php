<div>
    ...
    <div class="d-flex justify-content-end">
        <button wire:click='btnCreateCategory_Clicked' class="btn btn-sm btn-success mb-3 mx-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#createCategory" aria-controls="createCategory">
            Create Category
        </button>
        <button wire:navigate href="/budget/subcategory" class="btn btn-sm btn-primary mb-3 mx-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#createSubCategory" aria-controls="createSubCategory">
            Back
        </button>
    </div>
            ...
            <tbody>
                @foreach ($categories ?? [] as $category)
                    <tr>
                        ...
                        <td>
                            <button wire:click='editCategory({{ $category->id }})' class="btn btn-sm text-warning col">
