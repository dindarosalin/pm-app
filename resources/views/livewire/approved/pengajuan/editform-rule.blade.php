<div>
    ...
    <div wire:ignore.self class="offcanvas offcanvas-end" tabindex="-1" id="editRule" aria-labelledby="editRuleLabel">
        ...
        <div class="offcanvas-body">
            <form wire:submit.prevent="update">
                <div class="mb-3">
                    ...
                    <input type="text" wire:model="file_name" placeholder="Nama File">
                    <input type="file" wire:model="newFileRule" class="form-control form-control-sm">
